        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-12 text-center">
              <h2 className="section-heading text-uppercase">Locations</h2>
              <h3 className="section-subheading text-muted">List of available locations to visualize crime data (more coming soon).</h3>
            </div>
          </div>
          <div className="row">
            {
